...
public class CreateAttractionEntity {
    private Name place;
    ...
    public static class Name {
        ...
        public Name(String place_en, String place_ch, String place_tw, String place_jp) {
    ...
    public static class Address {
        ...
        public Address(String address_en, String address_ch, String address_tw, String address_jp) {
    ...
    public static class Time {
        ...
        public Time(List<String> mon, List<String> tue, List<String> wed, List<String> thu,
                    List<String> fri, List<String> sat, List<String> sun) {
            this.mon = mon;
            this.tue = tue;
            this.wed = wed;
            this.thu = thu;
